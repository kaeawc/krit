...
| 14 | Android-lint stubs | ✅ shipped | all 181 AOSP Android Lint Issue IDs have implementations (35 Manifest + 35 Resource + 13 Gradle + 13 Icon + 77 source-scanning); 3 stubs remain: `ScrollViewCount`, `DalvikOverride`, `OnClick`. Ongoing tracking → [`roadmap/clusters/android-lint/`](clusters/android-lint/README.md) |
