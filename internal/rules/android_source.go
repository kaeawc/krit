...
func checkUseValueOfKotlinCall(ctx *api.Context, r *UseValueOfRule, file *scanner.File, idx uint32) {
...
func checkUseValueOfJavaNew(ctx *api.Context, r *UseValueOfRule, file *scanner.File, idx uint32) {
