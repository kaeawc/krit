...
func TestFormatJSONColumns_MatchesFormatJSON(t *testing.T) {
	...
	FormatJSONColumns(&columnBuf, &columns, "1.2.3", 2, 5, start, perfTimings, activeRules, []string{"exp-a"}, cacheStats)
...
func TestColumnFormattersMatchSliceFormatters(t *testing.T) {
	...
	t.Run("json", func(t *testing.T) {
		...
		FormatJSONColumns(&got, &columns, "1.0.0", 3, 7, start, nil, nil, []string{"exp-a"}, nil)
