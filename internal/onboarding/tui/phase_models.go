...
func (writingPhaseModel) Update(_ tea.Msg) (phaseModel, tea.Cmd) {
...
func (autofixRunningPhaseModel) Update(_ tea.Msg) (phaseModel, tea.Cmd) {
...
func (baselineRunningPhaseModel) Update(_ tea.Msg) (phaseModel, tea.Cmd) {
...
func (p donePhaseModel) View() string {
	...
	b.WriteString("\n")
	fmt.Fprintf(&b, "  %s\n", p.configPath)
	fmt.Fprintf(&b, "  based on: %s profile\n", p.selected)
	fmt.Fprintf(&b, "  live finding count: %d\n", p.liveTotal)
	b.WriteString("\n")
