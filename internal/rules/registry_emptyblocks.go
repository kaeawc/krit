...
func registerEmptyblocksRules() {
	registerEmptyblocksEmptyCatchBlock()
	registerEmptyblocksEmptyClassBlock()
	registerEmptyblocksEmptyDefaultConstructor()
	registerEmptyblocksEmptyDoWhileBlock()
	registerEmptyblocksEmptyElseBlock()
	registerEmptyblocksEmptyFinallyBlock()
	registerEmptyblocksEmptyForBlock()
	registerEmptyblocksEmptyFunctionBlock()
	registerEmptyblocksEmptyIfBlock()
	registerEmptyblocksEmptyInitBlock()
	registerEmptyblocksEmptyKotlinFile()
	registerEmptyblocksEmptySecondaryConstructor()
	registerEmptyblocksEmptyTryBlock()
	registerEmptyblocksEmptyWhenBlock()
	registerEmptyblocksEmptyWhileBlock()
}
...
func registerEmptyblocksEmptyCatchBlock() {
	...
	api.Register(&api.Rule{
		...
		Check: func(ctx *api.Context) {
			...
			if blockHasCommentFlat(file, idx) {
				return
			}
...
func registerEmptyblocksEmptyClassBlock() {
...
func registerEmptyblocksEmptyDefaultConstructor() {
...
func registerEmptyblocksEmptyDoWhileBlock() {
	...
	api.Register(&api.Rule{
		ID: r.RuleName, Category: r.RuleSetName, Description: r.Desc, Sev: api.Severity(r.Sev),
		NodeTypes: []string{"do_while_statement", "do_statement"}, Languages: []scanner.Language{scanner.LangKotlin, scanner.LangJava}, Confidence: 0.95, Fix: api.FixSemantic, Implementation: r,
		Check: func(ctx *api.Context) {
			idx, file := ctx.Idx, ctx.File
			if !isBlockEmptyFlat(file, idx) {
				return
...
func registerEmptyblocksEmptyElseBlock() {
...
func registerEmptyblocksEmptyFinallyBlock() {
	...
	api.Register(&api.Rule{
		ID: r.RuleName, Category: r.RuleSetName, Description: r.Desc, Sev: api.Severity(r.Sev),
		NodeTypes: []string{"finally_block", "finally_clause"}, Languages: []scanner.Language{scanner.LangKotlin, scanner.LangJava}, Confidence: 0.95, Fix: api.FixSemantic, Implementation: r,
		Check: func(ctx *api.Context) {
			idx, file := ctx.Idx, ctx.File
			if !isBlockEmptyFlat(file, idx) {
				return
...
func registerEmptyblocksEmptyForBlock() {
	...
	api.Register(&api.Rule{
		ID: r.RuleName, Category: r.RuleSetName, Description: r.Desc, Sev: api.Severity(r.Sev),
		NodeTypes: []string{"for_statement", "enhanced_for_statement"}, Languages: []scanner.Language{scanner.LangKotlin, scanner.LangJava}, Confidence: 0.95, Fix: api.FixSemantic, Implementation: r,
		Check: func(ctx *api.Context) {
			idx, file := ctx.Idx, ctx.File
			if file.Language == scanner.LangJava {
				if !isBlockEmptyFlat(file, idx) {
...
func registerEmptyblocksEmptyIfBlock() {
...
func registerEmptyblocksEmptyInitBlock() {
...
func registerEmptyblocksEmptyKotlinFile() {
...
func registerEmptyblocksEmptySecondaryConstructor() {
...
func registerEmptyblocksEmptyTryBlock() {
	...
	api.Register(&api.Rule{
		ID: r.RuleName, Category: r.RuleSetName, Description: r.Desc, Sev: api.Severity(r.Sev),
		NodeTypes: []string{"try_expression", "try_statement"}, Languages: []scanner.Language{scanner.LangKotlin, scanner.LangJava}, Confidence: 0.95, Fix: api.FixSemantic, Implementation: r,
		Check: func(ctx *api.Context) {
			idx, file := ctx.Idx, ctx.File
			text := file.FlatNodeText(idx)
...
func registerEmptyblocksEmptyWhenBlock() {
	...
	api.Register(&api.Rule{
		ID: r.RuleName, Category: r.RuleSetName, Description: r.Desc, Sev: api.Severity(r.Sev),
		NodeTypes: []string{"when_expression"}, Confidence: 0.95, Fix: api.FixSemantic, Implementation: r,
		Check: func(ctx *api.Context) {
			idx, file := ctx.Idx, ctx.File
			hasEntries := false
...
func registerEmptyblocksEmptyWhileBlock() {
	...
	api.Register(&api.Rule{
		ID: r.RuleName, Category: r.RuleSetName, Description: r.Desc, Sev: api.Severity(r.Sev),
		NodeTypes: []string{"while_statement"}, Languages: []scanner.Language{scanner.LangKotlin, scanner.LangJava}, Confidence: 0.95, Fix: api.FixSemantic, Implementation: r,
		Check: func(ctx *api.Context) {
			idx, file := ctx.Idx, ctx.File
			if !isBlockEmptyFlat(file, idx) {
				return
