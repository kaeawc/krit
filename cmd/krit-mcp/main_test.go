...
// mcpMessage builds a newline-delimited MCP/JSON-RPC message — krit-mcp
// speaks NDJSON over stdio per the MCP spec.
...
// readMCPMessage reads one newline-delimited JSON message from a reader,
