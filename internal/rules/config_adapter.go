...
//
// The rule metadata runtime reads YAML-derived values through a small interface
// so rule metadata stays free of any YAML-specific plumbing. This
...
// NewConfigAdapter wraps cfg in a api.ConfigSource-compatible adapter.
...
// Compile-time check that ConfigAdapter satisfies the rule metadata contract.
var _ api.ConfigSource = (*ConfigAdapter)(nil)
