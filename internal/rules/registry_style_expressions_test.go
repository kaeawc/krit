...
// TestRegisterStyleExpressionsRules_AllRulesPresent guards against silently
// dropping a rule when registerStyleExpressionsRules() splits its inlined
// blocks across per-rule helper functions.
func TestRegisterStyleExpressionsRules_AllRulesPresent(t *testing.T) {
	expected := []string{
