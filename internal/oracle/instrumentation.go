...
// reduced user CPU without increasing wall time in local benchmarks.
...
// one-shot krit-types analysis. Explicit KRIT_TYPES_SHARDS disables the default
// to avoid nesting file-level parallelism inside every JVM shard; setting
