...
class Crypto {
    ...
    // Go misses these because it looks for `".toByteArray(` and
    // `Base64.getDecoder().decode(` as contiguous text; FIR is correct because
    // the calls are the same across a line break.
    fun lineBreaks() {
