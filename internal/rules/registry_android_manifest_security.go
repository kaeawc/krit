...
func registerAndroidManifestSecurityRules() {
	...
	{
		r := &DeepLinkMissingAutoVerifyRule{AndroidRule: AndroidRule{
			BaseRule:   BaseRule{RuleName: "DeepLinkMissingAutoVerify", RuleSetName: "security", Sev: "warning"},
			IssueID:    "DeepLinkMissingAutoVerify",
			Brief:      "Deep link intent filter missing autoVerify",
			Category:   ALCSecurity,
			ALSeverity: ALSWarning,
			Priority:   7,
			Origin:     "Krit",
	...
	{
		r := &NetworkSecurityConfigDebugOverridesRule{AndroidRule: AndroidRule{
			BaseRule:   BaseRule{RuleName: "NetworkSecurityConfigDebugOverrides", RuleSetName: "security", Sev: "warning"},
			IssueID:    "NetworkSecurityConfigDebugOverrides",
			Brief:      "Debug overrides in release network security config",
			Category:   ALCSecurity,
			ALSeverity: ALSWarning,
			Priority:   7,
			Origin:     "Krit",
