...
//
// v2 stores suppression-filtered cross findings. v1 stored raw rule output,
// which required parsed source files to reapply suppression on every load.
const crossFindingsCacheVersion uint32 = 2
