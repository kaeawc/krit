...
// ForEachOnRangeRule detects (range).forEach patterns using AST dispatch:
// .., rangeTo, until, downTo, ..< on any literal type (int, long, char,
// unsigned) and through chained calls like .reversed(), .step().
