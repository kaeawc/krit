...
func TestRunSampleFindingsColumns_MatchesSliceOutput(t *testing.T) {
	...
	gotStdout, gotStderr, gotCode := captureCLIOutput(t, func() int {
		return scan.RunSampleFindingsColumns(&columns, "UnusedVariable", 2, 1, dir)
	})
...
func TestRunBaselineAuditColumns_MatchesSliceOutput(t *testing.T) {
	...
	gotStdout, gotStderr, gotCode := captureCLIOutput(t, func() int {
		return scan.RunBaselineAuditColumns(&columns, baseline, baselinePath, dir, []string{dir}, "plain")
	})
...
func TestRunRuleAuditColumns_MatchesSliceOutput(t *testing.T) {
	...
	gotStdout, gotStderr, gotCode := captureCLIOutput(t, func() int {
		return scan.RunRuleAuditColumns(&columns, opts)
	})
...
func TestRunDeadCodeRemovalColumns_MatchesSliceOutput(t *testing.T) {
	...
	gotStdout, gotStderr, gotCode := captureCLIOutput(t, func() int {
		return scan.RunDeadCodeRemovalColumns(&columns, "json", true, "")
	})
...
func TestFilterFixesByLevelColumns_StripsOnlyDisallowedTextFixes(t *testing.T) {
	...
	registry := []*api.Rule{
		{ID: "CosmeticRule", Category: "style", Sev: api.SeverityWarning, Fix: api.FixCosmetic},
		{ID: "SemanticRule", Category: "style", Sev: api.SeverityWarning, Fix: api.FixSemantic},
		{ID: "BinaryRule", Category: "style", Sev: api.SeverityWarning, Fix: api.FixSemantic},
	}

	fixableCount, strippedByLevel := scan.FilterFixesByLevelColumns(&columns, registry, rules.FixCosmetic)
