...
func (it *ImportTable) Resolve(simpleName string) string {
	...
	// Kotlin auto-imports java.lang.* simple names without an explicit
	// import statement. Consult that table last so explicit imports,
	// aliases, primitives, and stdlib mappings still win.
