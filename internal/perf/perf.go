...
// NewWithNow returns an enabled Tracker that reads time from nowFn.
// Pass a deterministic function to drive timings in tests.
func NewWithNow(nowFn func() time.Time) Tracker {
	return &realTracker{nowFn: nowFn}
}
