...
// can later be reassigned or overridden. Go reports each of these because the
// argument starts with a string literal followed by `.toByteArray(`. Local
// vars are in StaticIvLocalVars.
package test
