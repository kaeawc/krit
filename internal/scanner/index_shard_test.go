...
// invariant; a regression that re-serialised File would silently bloat
// shard payloads again.
...
// bypass compression; the magic-byte check makes that loud.
...
// removes a pre-v3 shards/ directory so dead data does not accumulate
// after the upgrade.
...
// does not overflow to ~100% FPR at a realistic shard count. This uses
// smaller numbers than a large repository while still exercising the same
// math.
