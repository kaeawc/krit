...
// mustParseOraclePackHeader re-parses a buffer that buildOraclePack just
// produced in-memory. A failure here means buildOraclePack and
// parseOraclePackHeader have drifted — a programmer error, not an IO
// condition. Disk-load paths use parseOraclePackHeader directly and
