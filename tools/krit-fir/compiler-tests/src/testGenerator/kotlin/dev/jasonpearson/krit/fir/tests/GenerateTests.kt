...
//
// Output: build/generated/source/tests/dev/jasonpearson/krit/fir/tests/GeneratedDiagnosticTests.kt
fun main(args: Array<String>) {
    ...
    outputDir.resolve("dev/jasonpearson/krit/fir/tests").mkdirs()
    val out = outputDir.resolve("dev/jasonpearson/krit/fir/tests/GeneratedDiagnosticTests.kt")

    out.writeText(buildString {
        appendLine("// AUTO-GENERATED — do not edit; run :compiler-tests:generateTests to regenerate")
        appendLine("package dev.jasonpearson.krit.fir.tests")
        appendLine()
